...
class environmentObject:
    def __init__(self, name, x, y):
        ...
        elif name == 'desertCaveLargeFlower':
        ...
        elif name == 'desertCaveLumisTreeB':
        ...
        elif name == 'desertCaveLumisTreeC':
        ...
        elif name == 'desertCaveLumisTreeD':
        ...
        elif name == 'desertCaveLumisTreeE':
        ...
        elif name == 'desertCaveLumisTreeF':
        ...
        elif name == 'desertCaveLumisTreeG':
        ...
        elif name == 'desertCaveLumisTreeH':
