...
class foe:
    def __init__(self, name, centerx, centery, room, dependentFoes=None, **extra):
        ...
        actions = {'brokenTurret': self.actAsBrokenTurret, 'flamingRobot': self.actAsFlamingRobot,
                   ...
                   'desertCaveMoth': self.actAsDesertCaveMoth}
    ...
    def actAsDesertCaveMoth(self, target):
        ...
        self.t += math.pi / 100 * self.deltaTSign
        ...
        if self.fireCooldown <= 0:
            ...
            self.fireCooldown = random.randint(5, 100)
    ...
    def basicSpreadShot(self, qty, totalAngle, target, speed, sprite, damage, animation=None):
        ...
        for i in range(qty):
            ...
            self.newBullets.append(bullet(math.cos(angle) * speed, math.sin(angle) * speed,
                                              damage, sprite, self.x, self.y, animation=animation))
